...
public class AuthorController {
    ...
    public AuthorResponse updateProduct(@PathVariable("id") Long authorId, @RequestBody AuthorRequest body) throws NotFoundException {
        return new AuthorResponse(this.service.update(authorId, body));
    }

    @DeleteMapping(value = "/{id}")
    public void deleteProduct(@PathVariable("id") Long authorId) throws NotFoundException {
